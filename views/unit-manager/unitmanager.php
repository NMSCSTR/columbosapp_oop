...
<div id="viewModal"
    class="fixed inset-0 bg-black bg-opacity-50 z-50 hidden items-center justify-center backdrop-blur-sm transition-all duration-300">
        ...
        <form id="profileForm" class="space-y-6" onsubmit="updateProfile(event)">
            ...
            <div>
                ...
                <input type="password" id="current_password" name="current_password"
                    class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500"
                    placeholder="Enter current password to make changes" required>
            </div>

            <div class="grid grid-cols-2 gap-6">
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2" for="new_password">New Password
                        (Optional)</label>
                ...
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2" for="confirm_password">Confirm New
                        Password</label>
            ...
            <div class="flex justify-end space-x-4">
                <button type="button" onclick="closeProfileModal()"
                    class="px-4 py-2 text-sm font-medium text-gray-700 bg-gray-100 rounded-lg hover:bg-gray-200 focus:ring-4 focus:ring-gray-200 transition-colors duration-200">
                    Cancel
                </button>
                <button type="submit"
                    class="px-4 py-2 text-sm font-medium text-white bg-green-600 rounded-lg hover:bg-green-700 focus:ring-4 focus:ring-green-200 transition-colors duration-200">
                    Save Changes
                </button>
            </div>
        </form>
...
<main class="flex-1 p-6 md:p-8 overflow-y-auto bg-gradient-to-br from-gray-50 to-gray-100">
    ...
    <!-- Dashboard Section -->
    <div x-show="activeSection === 'dashboard'" class="space-y-8" x-transition:enter="transition ease-out duration-300"
        x-transition:enter-start="opacity-0 transform -translate-y-4"
        x-transition:enter-end="opacity-100 transform translate-y-0">
        <!-- Welcome Header with Gradient Background -->
        <div
            class="relative overflow-hidden bg-gradient-to-r from-green-500 to-green-600 rounded-2xl p-8 text-white mb-8">
            <div class="relative z-10">
                <h1 class="text-4xl font-bold mb-2 text-green-700">Welcome Back,
            ...
            <div
                class="absolute right-0 top-0 h-full w-1/2 bg-gradient-to-l from-green-400 opacity-20 transform rotate-12">
            </div>
        </div>

        <!-- Profile Card -->
        <div
            class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 mb-8 hover:shadow-lg transition-shadow duration-300">
            <div class="flex items-start space-x-6">
                <div class="flex-shrink-0">
                    <div class="w-24 h-24 rounded-2xl flex items-center justify-center shadow-lg">
                        <span
                            class="text-4xl font-bold text-green-700"><?php echo strtoupper(substr($_SESSION['firstname'], 0, 1) . substr($_SESSION['lastname'], 0, 1)) ?></span>
                    </div>
                </div>
                <div class="flex-grow">
                    <div class="flex justify-between items-start">
                        <div>
                            ...
                            <p class="text-gray-600 mb-3">
                                <?php echo isset($_SESSION['email']) ? $_SESSION['email'] : 'Email not set' ?></p>
                        </div>
                        <button onclick="openProfileModal()"
                            class="px-4 py-2 text-sm font-medium text-white bg-green-600 rounded-xl hover:bg-green-700 focus:ring-4 focus:ring-green-200 transition-all duration-200 shadow-sm hover:shadow-md">
                    ...
                    <div class="grid grid-cols-2 gap-4 mt-4">
                        <div class="bg-gray-50 p-4 rounded-xl border border-gray-100">
                            ...
                            <p class="font-semibold text-gray-800">
                                <?php echo ucwords(str_replace('-', ' ', $_SESSION['role'])) ?></p>
                        </div>
                        <div class="bg-gray-50 p-4 rounded-xl border border-gray-100">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl p-6 border border-blue-200">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <div class="text-right">
                        <p class="text-3xl font-bold text-blue-700"><?php echo $totalsByUnitManager['total_applicants'] ?? 0 ?></p>
            ...
            <div class="bg-gradient-to-br from-green-50 to-green-100 rounded-xl p-6 border border-green-200">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <div class="text-right">
                        <p class="text-2xl font-bold text-green-700">₱<?php echo number_format($totalsByUnitManager['total_face_value'] ?? 0, 0) ?></p>
            ...
            <div class="bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl p-6 border border-purple-200">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <div class="text-right">
                        <p class="text-2xl font-bold text-purple-700">₱<?php echo number_format($totals['total_contribution'] ?? 0, 0) ?></p>
                ...
                <div class="bg-gradient-to-r from-red-50 to-red-100 rounded-lg p-4 border border-red-200">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-xl font-bold text-red-700">₱<?php echo number_format($totals['insurance_cost'] ?? 0, 0) ?></p>
                        </div>
                ...
                <div class="bg-gradient-to-r from-yellow-50 to-yellow-100 rounded-lg p-4 border border-yellow-200">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-xl font-bold text-yellow-700">₱<?php echo number_format($totals['admin_fee'] ?? 0, 0) ?></p>
                        </div>
                ...
                <div class="bg-gradient-to-r from-emerald-50 to-emerald-100 rounded-lg p-4 border border-emerald-200">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-xl font-bold text-emerald-700">₱<?php echo number_format($totals['savings_fund'] ?? 0, 0) ?></p>
                        </div>
    ...
    <div x-show="activeSection === 'orders'" class="space-y-8" x-transition:enter="transition ease-out duration-300"
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 overflow-hidden">
            <div class="overflow-x-auto">
                <table id="myTable" class="stripe hover w-full border-collapse"
                    ...
                    <tbody class="text-sm">
                        ...
                        <tr class="border-b border-gray-200 hover:bg-gray-50 transition-colors duration-200">
                            <td class="px-4 py-3 text-gray-700 font-medium whitespace-nowrap">
                                <?php echo htmlspecialchars($applicant['applicant_name']) ?></td>
                            <td class="px-4 py-3 text-gray-700 whitespace-nowrap">
                                <?php echo htmlspecialchars($applicant['plan_type']) ?></td>
                            <td class="px-4 py-3 text-gray-700 whitespace-nowrap">
                                <?php echo htmlspecialchars($applicant['plan_name']) ?></td>
                            <td class="px-4 py-3 text-gray-700 whitespace-nowrap">
                                ₱<?php echo htmlspecialchars(number_format($applicant['face_value'], 2)) ?></td>
                            <td class="px-4 py-3 text-gray-700 whitespace-nowrap">
                                <?php echo htmlspecialchars($applicant['years_to_maturity']) ?></td>
                            <td class="px-4 py-3 text-gray-700 whitespace-nowrap">
                                <?php echo htmlspecialchars($applicant['years_of_protection']) ?></td>
                            <td class="px-4 py-3 text-gray-700 whitespace-nowrap">
                                <?php echo htmlspecialchars($applicant['payment_mode']) ?></td>
                            <td class="px-4 py-3 text-gray-700 whitespace-nowrap">
    ...
    <!-- Forms Section -->
    <div x-show="activeSection === 'forms'" class="space-y-8" x-transition:enter="transition ease-out duration-300"
        x-transition:enter-start="opacity-0 transform -translate-y-4"
        x-transition:enter-end="opacity-100 transform translate-y-0">
        <!-- Section Header -->
        <div
            class="relative overflow-hidden bg-gradient-to-r from-blue-500 to-blue-600 rounded-2xl p-8 text-white mb-8">
            <div class="relative z-10">
            ...
            <div
                class="absolute right-0 top-0 h-full w-1/2 bg-gradient-to-l from-blue-400 opacity-20 transform rotate-12">
            </div>
        </div>
            ...
            <table id="myTable2" class="stripe hover w-full" style="width:100%">
                ...
                <tbody class="text-sm">
                    ...
                    <tr class="border-b hover:bg-gray-50 transition-colors duration-200">
                        ...
                        <td class="px-4 py-3">
                            <span
                                class="px-3 py-1 text-xs rounded-full font-medium                                                                                                                                                                                                                                                    <?php echo strtolower($row['file_type']) === 'pdf' ? 'bg-red-100 text-red-700' : 'bg-blue-100 text-blue-700' ?>">
                                <?php echo htmlspecialchars($row['file_type']) ?>
                            </span>
                        </td>
                        <td class="px-4 py-3 text-gray-700"><?php echo date("F j, Y", strtotime($row['uploaded_on'])) ?>
                        </td>
...
<div x-show="activeSection === 'council'" class="space-y-8" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 transform -translate-y-4" x-transition:enter-end="opacity-100 transform translate-y-0">
    ...
    <div x-show="activeSection === 'fraternalbenefits'" class="space-y-8"
        x-transition:enter="transition ease-out duration-300"
        x-transition:enter-start="opacity-0 transform -translate-y-4"
        x-transition:enter-end="opacity-100 transform translate-y-0">
        <!-- Section Header -->
        <div
            class="relative overflow-hidden bg-gradient-to-r from-indigo-500 to-indigo-600 rounded-2xl p-8 text-white mb-8">
            <div class="relative z-10">
            ...
            <div
                class="absolute right-0 top-0 h-full w-1/2 bg-gradient-to-l from-indigo-400 opacity-20 transform rotate-12">
            </div>
        </div>
            ...
            <table id="myTable4" class="stripe hover w-full" style="width:100%">
                ...
                <tbody class="text-sm">
                    ...
                    <tr class="border-b hover:bg-gray-50 transition-colors duration-200">
                        <td class="px-4 py-3">
                            <span
                                class="px-3 py-1 text-xs rounded-full font-medium                                                                                                                                                                                                                                                <?php echo strtolower($fraternal['type']) === 'premium' ? 'bg-purple-100 text-purple-700' : 'bg-blue-100 text-blue-700' ?>">
    ...
    <div x-show="activeSection === 'announcement'" class="space-y-8"
        x-transition:enter="transition ease-out duration-300"
        x-transition:enter-start="opacity-0 transform -translate-y-4"
        x-transition:enter-end="opacity-100 transform translate-y-0">
        <!-- Section Header -->
        <div
            class="relative overflow-hidden bg-gradient-to-r from-yellow-500 to-yellow-600 rounded-2xl p-8 text-white mb-8">
            <div class="relative z-10">
            ...
            <div
                class="absolute right-0 top-0 h-full w-1/2 bg-gradient-to-l from-yellow-400 opacity-20 transform rotate-12">
            </div>
        </div>
        ...
        <div class="space-y-6">
            ...
            <div
                ...
                <div class="flex items-start space-x-4">
                    <div class="flex-shrink-0">
                        <div
                            class="w-12 h-12 bg-gradient-to-br from-yellow-400 to-yellow-500 rounded-xl flex items-center justify-center shadow-sm">
                            <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div class="flex-1">
                        <div class="flex items-center justify-between mb-2">
                            <h3 class="text-lg font-semibold text-gray-900">
                                <?php echo htmlspecialchars($announcement['subject']) ?></h3>
