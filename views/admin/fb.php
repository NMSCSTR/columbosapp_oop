            ...
            <div class="grid gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="name" id="name"
                        class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50"
                        placeholder="e.g., KC Term Protect 5" required>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <label for="face_value" class="block text-sm font-medium text-gray-700">Face Value Summary</label>
                        <div class="mt-1 relative rounded-lg shadow-sm">
                            <input type="text" name="face_value" id="face_value"
                                class="block w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50"
                                placeholder="e.g., 50k - 100k & up" required>
                        </div>
                        <p class="text-xs text-gray-500 mt-1">Brief description only. Set actual rates later.</p>
                    </div>
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            ...
                            <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2">Fraternal Benefits</span>
                        </div>
                    </li>
                </ol>
            </nav>
                            ...
                            if ($fraternals) {
                                foreach ($fraternals as $fraternal) {?>
                                    <tr class="table-row bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                        <td class="px-6 py-4">
                                            <span class="badge <?php
                                                ...
                                                switch(strtolower(str_replace(' ', '', $fraternal['type']))) {
                                                    case 'investmentplan': echo 'badge-investment'; break;
                                                    case 'retirementplan': echo 'badge-retirement'; break;
                                                    case 'educationalplan': echo 'badge-educational'; break;
                                                    case 'protectionplan': echo 'badge-protection'; break;
                                                    case 'termplan': echo 'badge-term'; break;
                                        ...
                                        <td class="px-6 py-4">
                                            <?= htmlspecialchars($fraternal['face_value']) ?>
                                        </td>
                                        <td class="px-6 py-4">
                                        ...
                                        <td class="px-6 py-4">
                                            <div class="flex items-center space-x-3">
                                                ...
                                                <a href="manageRates.php?id=<?= $fraternal['id'] ?>" 
                                                   class="action-button inline-flex items-center px-3 py-1.5 text-xs font-medium text-indigo-700 bg-indigo-100 rounded-lg hover:bg-indigo-200 focus:ring-2 focus:ring-indigo-300 transition-colors duration-200">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Image upload and drag/drop scripts...
