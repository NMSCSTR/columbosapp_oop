        ...
        <div class="p-4 sm:ml-64">
            ...
            <section class="form-card bg-white dark:bg-gray-800 shadow-lg rounded-xl overflow-hidden border border-gray-200 dark:border-gray-700">
                ...
                <div class="overflow-x-auto p-6">
                    <table id="myFormsTable" class="w-full text-sm text-left text-gray-500 dark:text-gray-400 stripe hover" style="width:100%">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if ($.fn.DataTable.isDataTable('#myFormsTable')) {
        $('#myFormsTable').DataTable().destroy();
    }
    
    $('.dt-buttons').remove();
    
    $('#myFormsTable').DataTable({
        responsive: true,
        pageLength: 10,
        dom: 'Bfrtip',
        buttons: [
