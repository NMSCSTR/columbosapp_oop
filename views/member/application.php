  ...
  <div class="max-w-6xl mx-auto bg-white p-8 rounded-xl shadow-md">
    ...
    <div class="mb-6">
      ...
      <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-4">
        <input type="text" placeholder="Last Name" class="input col-span-1">
        <input type="text" placeholder="First Name" class="input col-span-1">
        <input type="text" placeholder="M.I." class="input col-span-1">
        <input type="date" placeholder="Birth Date" class="input col-span-1">
      </div>
      ...
      <div class="mb-2">
        ...
        <p class="text-xs italic text-red-500 mt-1">*Does not need to be included on this form, but should be memorized.</p>
      </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
        <div>
          ...
          <input type="text" placeholder="If no, are you authorized to work in the U.S.? YES / NO" class="input mt-2">
        </div>
    ...
    <div class="mb-6">
      ...
      <p class="text-sm italic mb-2">
        Please list any achievements you have received and/or organizations and activities that you have participated in.
      </p>
